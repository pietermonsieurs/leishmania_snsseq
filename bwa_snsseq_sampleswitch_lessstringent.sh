...
export MACS_DIR=/user/antwerpen/205/vsc20587/scratch/leishmania_snsseq/results/macs_switch/
...
#### SKIP!!! STEP 6: select only the proper paired reads
...
## 7.1 run flagstat
# samtools flagstat $BWA_DIR/1_S1.removedups.bam > $BWA_DIR/1_S1.removedups.flagstat
# samtools flagstat $BWA_DIR/2_S2.removedups.bam > $BWA_DIR/2_S2.removedups.flagstat
# samtools flagstat $BWA_DIR/3_S3.removedups.bam > $BWA_DIR/3_S3.removedups.flagstat
# samtools flagstat $BWA_DIR/4_S4.removedups.bam > $BWA_DIR/4_S4.removedups.flagstat
...
# sample S1
ln -s $BWA_DIR/1_S1.removedups.bam $BWA_DIR/1_S1.removedups.subsample.bam

# sample S2
samtools view -@$THREADS -bs 10.5357 $BWA_DIR/2_S2.removedups.bam > $BWA_DIR/2_S2.removedups.subsample.bam

# sample S3
samtools view -@$THREADS -bs 10.6931 $BWA_DIR/3_S3.removedups.bam > $BWA_DIR/3_S3.removedups.subsample.bam

# sample S4
samtools view -@$THREADS -bs 10.8657 $BWA_DIR/4_S4.removedups.bam > $BWA_DIR/4_S4.removedups.subsample.bam

samtools index $BWA_DIR/1_S1.removedups.subsample.bam
samtools index $BWA_DIR/2_S2.removedups.subsample.bam
samtools index $BWA_DIR/3_S3.removedups.subsample.bam
samtools index $BWA_DIR/4_S4.removedups.subsample.bam
...
# sample S2 - control S1
# /user/antwerpen/205/vsc20587/software/python_lib/bin/macs2 callpeak -f BAM -g 38e6 --nomodel --extsize 150 -n S2 -t $BWA_DIR/2_S2.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam -c $BWA_DIR/1_S1.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam --outdir $MACS_DIR

# sample S4 - control S3
# /user/antwerpen/205/vsc20587/software/python_lib/bin/macs2 callpeak -f BAM -g 38e6 --nomodel --extsize 150  -n S4 -t $BWA_DIR/4_S4.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam -c $BWA_DIR/3_S3.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam --outdir $MACS_DIR

# sample S2 - control S1 - BROAD peak
# /user/antwerpen/205/vsc20587/software/python_lib/bin/macs2 callpeak -f BAM -g 38e6 --nomodel --extsize 150 --broad -n S2 -t $BWA_DIR/2_S2.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam -c $BWA_DIR/1_S1.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam --outdir $MACS_DIR

# sample S4 - control S3 - BROAD peak
# /user/antwerpen/205/vsc20587/software/python_lib/bin/macs2 callpeak -f BAM -g 38e6 --nomodel --extsize 150 --broad -n S4 -t $BWA_DIR/4_S4.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam -c $BWA_DIR/3_S3.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam --outdir $MACS_DIR
