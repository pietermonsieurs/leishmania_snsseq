...
export DATA_DIR=/user/antwerpen/205/vsc20587/scratch/leishmania_snsseq/data/wt/
export REF_DIR=/user/antwerpen/205/vsc20587/scratch/leishmania_snsseq/data/
...
# gunzip all fastq files, as they need to be unzipped to be able to 
# do a filtering on the minimum read length.
# for fastq_file in $DATA_DIR/*.fastq.gz
#   do
#     # echo $fastq_file
#     gunzip $fastq_file
# done

# $BIN_DIR/reads_filtering_on_length.sh $DATA_DIR/5_S5_L001_R1_001.fastq $DATA_DIR/5_S5_L001_R2_001.fastq $MIN_L
# $BIN_DIR/reads_filtering_on_length.sh $DATA_DIR/6_S6_L001_R1_001.fastq $DATA_DIR/6_S6_L001_R2_001.fastq $MIN_L
# $BIN_DIR/reads_filtering_on_length.sh $DATA_DIR/7R_S7_L001_R1_001.fastq $DATA_DIR/7R_S7_L001_R2_001.fastq $MIN_L
# $BIN_DIR/reads_filtering_on_length.sh $DATA_DIR/8R_S8_L001_R1_001.fastq $DATA_DIR/8R_S8_L001_R2_001.fastq $MIN_L

# ### STEP 2: rename and gzip ###
## rename all fastq-files and gzip them again 
# mv $DATA_DIR/5_S5_L001_R1_001.fastq.100 $DATA_DIR/5_S5_L001_R1_001.filter.fastq 
# mv $DATA_DIR/5_S5_L001_R2_001.fastq.100 $DATA_DIR/5_S5_L001_R2_001.filter.fastq 
# mv $DATA_DIR/6_S6_L001_R1_001.fastq.100 $DATA_DIR/6_S6_L001_R1_001.filter.fastq 
# mv $DATA_DIR/6_S6_L001_R2_001.fastq.100 $DATA_DIR/6_S6_L001_R2_001.filter.fastq 
# mv $DATA_DIR/7R_S7_L001_R1_001.fastq.100 $DATA_DIR/7R_S7_L001_R1_001.filter.fastq 
# mv $DATA_DIR/7R_S7_L001_R2_001.fastq.100 $DATA_DIR/7R_S7_L001_R2_001.filter.fastq 
# mv $DATA_DIR/8R_S8_L001_R1_001.fastq.100 $DATA_DIR/8R_S8_L001_R1_001.filter.fastq 
# mv $DATA_DIR/8R_S8_L001_R2_001.fastq.100 $DATA_DIR/8R_S8_L001_R2_001.filter.fastq 

# ## if needed, first do gzip of the fastq files
# gzip $DATA_DIR/5_S5_L001_R1_001.filter.fastq 
# gzip $DATA_DIR/5_S5_L001_R2_001.filter.fastq 
# gzip $DATA_DIR/6_S6_L001_R1_001.filter.fastq 
# gzip $DATA_DIR/6_S6_L001_R2_001.filter.fastq 
# gzip $DATA_DIR/7R_S7_L001_R1_001.filter.fastq 
# gzip $DATA_DIR/7R_S7_L001_R2_001.filter.fastq 
# gzip $DATA_DIR/8R_S8_L001_R1_001.filter.fastq 
# gzip $DATA_DIR/8R_S8_L001_R2_001.filter.fastq 
...
# bwa mem -t $THREADS -k $SEED $REF_DIR/refgenome/TriTrypDB-46_TbruceiLister427_2018_Genome.fasta $DATA_DIR/5_S5_L001_R1_001.filter.fastq.gz $DATA_DIR/5_S5_L001_R2_001.filter.fastq.gz | samtools sort -@$THREADS -o $BWA_DIR/5_S5.bam -

# bwa mem -t $THREADS -k $SEED $REF_DIR/refgenome/TriTrypDB-46_TbruceiLister427_2018_Genome.fasta $DATA_DIR/6_S6_L001_R1_001.filter.fastq.gz $DATA_DIR/6_S6_L001_R2_001.filter.fastq.gz | samtools sort -@$THREADS -o $BWA_DIR/6_S6.bam -

# bwa mem -t $THREADS -k $SEED $REF_DIR/refgenome/TriTrypDB-46_TbruceiLister427_2018_Genome.fasta $DATA_DIR/7R_S7_L001_R1_001.filter.fastq.gz $DATA_DIR/7R_S7_L001_R2_001.filter.fastq.gz | samtools sort -@$THREADS -o $BWA_DIR/7_S7.bam -

# bwa mem -t $THREADS -k $SEED $REF_DIR/refgenome/TriTrypDB-46_TbruceiLister427_2018_Genome.fasta $DATA_DIR/8R_S8_L001_R1_001.filter.fastq.gz $DATA_DIR/8R_S8_L001_R2_001.filter.fastq.gz | samtools sort -@$THREADS -o $BWA_DIR/8_S8.bam -

# # index all the bam files
# samtools index $BWA_DIR/5_S5.bam
# samtools index $BWA_DIR/6_S6.bam
# samtools index $BWA_DIR/7_S7.bam
# samtools index $BWA_DIR/8_S8.bam

# #### STEP 4: filtering on Mapping quality ####
# samtools view -@ $THREADS -bq $mapq_cutoff $BWA_DIR/5_S5.bam > $BWA_DIR/5_S5.mapq${mapq_cutoff}.bam
# samtools view -@ $THREADS -bq $mapq_cutoff $BWA_DIR/6_S6.bam > $BWA_DIR/6_S6.mapq${mapq_cutoff}.bam
# samtools view -@ $THREADS -bq $mapq_cutoff $BWA_DIR/7_S7.bam > $BWA_DIR/7_S7.mapq${mapq_cutoff}.bam
# samtools view -@ $THREADS -bq $mapq_cutoff $BWA_DIR/8_S8.bam > $BWA_DIR/8_S8.mapq${mapq_cutoff}.bam




#### STEP 5: remove duplicates ####
# $PICARD_BIN MarkDuplicates REMOVE_DUPLICATES=true I=$BWA_DIR/5_S5.mapq${mapq_cutoff}.bam O=$BWA_DIR/5_S5.mapq${mapq_cutoff}.removedups.bam M=$BWA_DIR/5_S5.markdups_metrics.txt
# $PICARD_BIN MarkDuplicates REMOVE_DUPLICATES=true I=$BWA_DIR/6_S6.mapq${mapq_cutoff}.bam O=$BWA_DIR/6_S6.mapq${mapq_cutoff}.removedups.bam M=$BWA_DIR/6_S6.markdups_metrics.txt
# $PICARD_BIN MarkDuplicates REMOVE_DUPLICATES=true I=$BWA_DIR/7_S7.mapq${mapq_cutoff}.bam O=$BWA_DIR/7_S7.mapq${mapq_cutoff}.removedups.bam M=$BWA_DIR/7_S7.markdups_metrics.txt
# $PICARD_BIN MarkDuplicates REMOVE_DUPLICATES=true I=$BWA_DIR/8_S8.mapq${mapq_cutoff}.bam O=$BWA_DIR/8_S8.mapq${mapq_cutoff}.removedups.bam M=$BWA_DIR/8_S8.markdups_metrics.txt

# # index all the bam files
# samtools index $BWA_DIR/5_S5.mapq${mapq_cutoff}.removedups.bam
# samtools index $BWA_DIR/6_S6.mapq${mapq_cutoff}.removedups.bam
# samtools index $BWA_DIR/7_S7.mapq${mapq_cutoff}.removedups.bam
# samtools index $BWA_DIR/8_S8.mapq${mapq_cutoff}.removedups.bam

# #### STEP 6: select only the proper paired reads
# samtools view -@$THREADS -bf 0x2 $BWA_DIR/5_S5.mapq${mapq_cutoff}.removedups.bam > $BWA_DIR/5_S5.mapq${mapq_cutoff}.removedups.proper_paired.bam 
# samtools view -@$THREADS -bf 0x2 $BWA_DIR/6_S6.mapq${mapq_cutoff}.removedups.bam > $BWA_DIR/6_S6.mapq${mapq_cutoff}.removedups.proper_paired.bam 
# samtools view -@$THREADS -bf 0x2 $BWA_DIR/7_S7.mapq${mapq_cutoff}.removedups.bam > $BWA_DIR/7_S7.mapq${mapq_cutoff}.removedups.proper_paired.bam
# samtools view -@$THREADS -bf 0x2 $BWA_DIR/8_S8.mapq${mapq_cutoff}.removedups.bam > $BWA_DIR/8_S8.mapq${mapq_cutoff}.removedups.proper_paired.bam 

# # # index all the bam files
# samtools index $BWA_DIR/5_S5.mapq${mapq_cutoff}.removedups.proper_paired.bam
# samtools index $BWA_DIR/6_S6.mapq${mapq_cutoff}.removedups.proper_paired.bam
# samtools index $BWA_DIR/7_S7.mapq${mapq_cutoff}.removedups.proper_paired.bam
# samtools index $BWA_DIR/8_S8.mapq${mapq_cutoff}.removedups.proper_paired.bam
...
## 7.1 run flagstat
# samtools flagstat $BWA_DIR/5_S5.mapq${mapq_cutoff}.removedups.proper_paired.bam > $BWA_DIR/5_S5.removedups.proper_paired.flagstat
# samtools flagstat $BWA_DIR/6_S6.mapq${mapq_cutoff}.removedups.proper_paired.bam > $BWA_DIR/6_S6.removedups.proper_paired.flagstat
# samtools flagstat $BWA_DIR/7_S7.mapq${mapq_cutoff}.removedups.proper_paired.bam > $BWA_DIR/7_S7.removedups.proper_paired.flagstat
# samtools flagstat $BWA_DIR/8_S8.mapq${mapq_cutoff}.removedups.proper_paired.bam > $BWA_DIR/8_S8.removedups.proper_paired.flagstat
...
# sample S5
samtools view -@$THREADS -bs 10.7236 $BWA_DIR/5_S5.mapq${mapq_cutoff}.removedups.proper_paired.bam > $BWA_DIR/5_S5.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam

# sample S6
samtools view -@$THREADS -bs 10.5871 $BWA_DIR/6_S6.mapq${mapq_cutoff}.removedups.proper_paired.bam > $BWA_DIR/6_S6.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam

# sample S7
ln -s $BWA_DIR/7_S7.mapq${mapq_cutoff}.removedups.proper_paired.bam $BWA_DIR/7_S7.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam

# sample S8
samtools view -@$THREADS -bs 10.6802 $BWA_DIR/8_S8.mapq${mapq_cutoff}.removedups.proper_paired.bam > $BWA_DIR/8_S8.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam

samtools index $BWA_DIR/5_S5.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam

samtools index $BWA_DIR/6_S6.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam

samtools index $BWA_DIR/7_S7.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam

samtools index $BWA_DIR/8_S8.mapq${mapq_cutoff}.removedups.proper_paired.subsample.bam
