...
export BWA_DIR=/user/antwerpen/205/vsc20587/scratch/leishmania_snsseq/results/bwa_lessstringent/
...
# #### SKIP!! STEP 4: filtering on Mapping quality ####
...
# $PICARD_BIN MarkDuplicates REMOVE_DUPLICATES=true I=$BWA_DIR/5_S5.bam O=$BWA_DIR/5_S5.removedups.bam M=$BWA_DIR/5_S5.markdups_metrics.txt
# $PICARD_BIN MarkDuplicates REMOVE_DUPLICATES=true I=$BWA_DIR/6_S6.bam O=$BWA_DIR/6_S6.removedups.bam M=$BWA_DIR/6_S6.markdups_metrics.txt
# $PICARD_BIN MarkDuplicates REMOVE_DUPLICATES=true I=$BWA_DIR/7_S7.bam O=$BWA_DIR/7_S7.removedups.bam M=$BWA_DIR/7_S7.markdups_metrics.txt
# $PICARD_BIN MarkDuplicates REMOVE_DUPLICATES=true I=$BWA_DIR/8_S8.bam O=$BWA_DIR/8_S8.removedups.bam M=$BWA_DIR/8_S8.markdups_metrics.txt

# index all the bam files
# samtools index $BWA_DIR/5_S5.removedups.bam
# samtools index $BWA_DIR/6_S6.removedups.bam
# samtools index $BWA_DIR/7_S7.removedups.bam
# samtools index $BWA_DIR/8_S8.removedups.bam
...
## 7.1 run flagstat
# samtools flagstat $BWA_DIR/5_S5.removedups.bam > $BWA_DIR/5_S5.removedups.flagstat
# samtools flagstat $BWA_DIR/6_S6.removedups.bam > $BWA_DIR/6_S6.removedups.flagstat
# samtools flagstat $BWA_DIR/7_S7.removedups.bam > $BWA_DIR/7_S7.removedups.flagstat
# samtools flagstat $BWA_DIR/8_S8.removedups.bam > $BWA_DIR/8_S8.removedups.flagstat
...
# sample S8
samtools view -@$THREADS -bs 10.7192 $BWA_DIR/8_S8.removedups.bam > $BWA_DIR/8_S8.removedups.subsample.bam


samtools index $BWA_DIR/5_S5.removedups.subsample.bam
samtools index $BWA_DIR/6_S6.removedups.subsample.bam
samtools index $BWA_DIR/7_S7.removedups.subsample.bam
samtools index $BWA_DIR/8_S8.removedups.subsample.bam
